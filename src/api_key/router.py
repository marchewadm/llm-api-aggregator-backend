...
from src.auth.dependencies import AuthDependency, AuthServiceDependency
from src.api_provider.dependencies import ApiProviderServiceDependency
from src.redis.dependencies import RedisServiceDependency
from .dependencies import ApiKeyServiceDependency

from .schemas import (
    ApiKeysPassphraseRequest,
...
async def get_api_keys(
    ...
    payload: ApiKeysPassphraseRequest,
):
    """
